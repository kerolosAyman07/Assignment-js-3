...
var boxModal = document.querySelector("#lightBox");
var bookmarks = [];
...
function displayBookmark(indexOfWebsite) {
    ...
    var newBookmark = `
              <tr>
                ...
                <td>
                  <button class="btn btn-visit bg-success text-white" data-index="${indexOfWebsite}"><i class="bi bi-eye-fill pe-2 "></i>Visit</button>
                </td>
                <td>
                  <button class="btn btn-delete pe-2 bg-danger text-white" data-index="${indexOfWebsite}"><i class="bi bi-trash3-fill"></i>Delete</button>
                </td>
            </tr>`;
...
submitBtn.addEventListener("click", function () {
    if (siteName.classList.contains("is-valid") && siteURL.classList.contains("is-valid")) {
        var bookmark = {siteName: capitalize(siteName.value),siteURL: siteURL.value};
